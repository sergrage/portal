        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="mt-3 text-dark font-weight-bold">Уровни водохранилищ</h1>
                        </div>
                        <div class="col-sm-12">
                            <yearselect-component></yearselect-component>
                            <reservoirselect-component></reservoirselect-component>
                            <safeexcel-component class="ml-3" style="margin-bottom: 7px;"></safeexcel-component>
                            @include('app.partials.date')
                        </div>
                        <reservoirs-component></reservoirs-component>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            <!-- /.content-header -->
