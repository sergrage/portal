    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link active">
                ...
                <p>Главная<i class="right fas fa-angle-left"></i>
                </p>
            </a>
        ...
        <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link active">
                ...
                <p>Управление<i class="right fas fa-angle-left"></i>
                </p>
            </a>
            <ul class="nav nav-treeview">
                <li class="nav-item">
        ...
        <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link active">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Параметры<i class="right fas fa-angle-left"></i>
                </p>
            </a>
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{route('administrator.year.index')}}" class="nav-link">
                        <i class="fas fa-fw fa-user nav-icon"></i>
                        <p>ЦГМС год</p>
                    </a>
                </li>
